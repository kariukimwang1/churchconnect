...
export const colors = {
  // Brand Colors - PCEA Theme (Red, Blue, White, Black)
  primary: '#2E3192',      // PCEA Blue - stable, traditional, spiritual
  primaryDark: '#1E2161',
  primaryLight: '#4E51B2',
  primaryTint: '#E9EAF7',

  secondary: '#ED1C24',    // PCEA Red - passion, Holy Spirit, energy
  secondaryDark: '#C1121C',
  secondaryLight: '#F25C62',
  secondaryTint: '#FDE8E9',

  accent: '#FBBF24',       // Gold - for highlighting special elements
  accentDark: '#D97706',
  accentLight: '#FCD34D',
  accentTint: '#FFFBEB',
